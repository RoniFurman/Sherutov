...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="bg-gray-50">
      {/* Hero Section */}
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16 text-center">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 text-gray-800 leading-tight">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-600 leading-relaxed mb-6 sm:mb-8 max-w-3xl mx-auto px-4 sm:px-0">
            אנחנו ב־SheruTov עוזרים לעסקים דיגיטליים לחסוך זמן, לשמור על לקוחות
            מרוצים ולהתרכז בצמיחה.
          </p>
          <p className="text-sm sm:text-base md:text-lg text-gray-700 mb-8 sm:mb-10 max-w-2xl mx-auto px-4 sm:px-0">
            אנחנו דואגים לשירות הלקוחות והאוטומציה – אתם מתמקדים במכירות ובניהול
            העסק.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4 sm:px-0">
            <a
              href="mailto:support@sherutov.com"
              className="bg-mainLogo text-white px-6 sm:px-8 py-3 rounded-lg hover:bg-mainLogoHover transition-colors duration-200 font-semibold text-base sm:text-lg">
              צור קשר עכשיו
            </a>
            <a
              ...
              className="border-2 border-mainLogo text-mainLogo px-6 sm:px-8 py-3 rounded-lg hover:bg-mainLogo hover:text-white transition-colors duration-200 font-semibold text-base sm:text-lg">
              WhatsApp
            </a>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 text-center">
            ...
            <div className="p-6">
              <div className="w-20 h-20 bg-iconColor rounded-full flex items-center justify-center mx-auto mb-4">
                <Award className="w-10 h-10 text-mainLogo" strokeWidth={1.5} />
              </div>
          ...
          <div className="bg-mainBackground p-4 sm:p-6 md:p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:transform hover:scale-105">
            <div className="flex items-start gap-3 sm:gap-4">
              ...
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                  טיפול ראשוני בבעיות לקוחות על מנת להוריד עומס מהעסק ולשמור על
                  חוויית לקוח מצוינת.
                </p>
              </div>
            </div>
      ...
      <section id="about" className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            ...
            לקוחות דיגיטלי, הטמעת אוטומציות, ומתן פתרונות מותאמים אישית לעסקים.
          </p>
        </div>
      </section>
      ...
      <section id="contact" className="bg-iconColor py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            צרו איתנו קשר היום לקבלת ייעוץ חינם ונגלה יחד איך נוכל לשפר את שירות
            הלקוחות שלכם
          </p>
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 bg-mainLogo hover:bg-mainLogoHover text-white p-3 sm:p-4 rounded-full shadow-2xl hover:shadow-mainLogoHover/50 transition-all duration-300 hover:scale-110 hover:-translate-y-1 z-50 border-2 border-white animate-pulse hover:animate-none"
          aria-label="חזור למעלה">
          <ChevronUp className="w-6 h-6 sm:w-8 sm:h-8" strokeWidth={2.5} />
        </button>
      )}
    </div>
  );
